...
Please remember that your "Proposition" should be useful to determine whether the "Hypothesis" is True, False.
----{{/system}}
...
{{/user}}
{{#assistant}}{{gen "is_something" temperature=temperature max_tokens=1 stop='\n'}}{{/assistant}}
''')
...
{{#assistant}}{{gen "validation" temperature=temperature max_tokens=1 stop='\n'}}{{/assistant}}
''')
...
{{#assistant}}{{gen "duplicated" temperature=temperature max_tokens=1 stop='\n'}}{{/assistant}}
''')
...
{{#assistant}}{{gen "sourced" temperature=temperature max_tokens=1 stop='\n'}}{{/assistant}}
''')
...
{{#assistant}}{{gen "judgement" temperature=temperature max_tokens=1 stop='\n'}}{{/assistant}}
''')
...
'''
{{#system}}Suppose you are one of the greatest AI scientists, logicians and mathematicians. Let us think step by step. 
Read and analyze the "Premises" first, then use "Propositions" to reasoning whether the "Hypothesis" is True, False.
Please make sure your reasoning is directly deduced from the "Premises" and "Propositions" other than introducing unsourced common knowledge and unsourced information by common sense reasoning.
...
{{#assistant}}{{gen "usefulness" temperature=temperature max_tokens=1 stop='\n'}}{{/assistant}}
''')
