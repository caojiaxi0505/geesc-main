...
python SAT-LM/run_multistage.py --task arlsat --run_pred --batch_size 5 --num_samples 1 --temperature 0.0 --sig_prompt_id sigz3 --trans_setting setupsatlm --eval_split test --num_dev -1 --do_impose ${FLAG}
}
