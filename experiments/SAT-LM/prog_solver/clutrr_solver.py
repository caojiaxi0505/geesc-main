...
def read_proglm_rules(filename="prog_solver/external/clutrr_proglm_rules.pkl"):
    with open("D:\LLM-Logic-Reasoner\SAT-LM\prog_solver\external\clutrr_proglm_rules.pkl", 'rb') as f:
        return pickle.load(f)

PROGLM_RULES = read_proglm_rules()

def read_satlm_rules(filename="D:\LLM-Logic-Reasoner\SAT-LM\prog_solver\external\clutrr_satlm_rules.txt"):
    d = OrderedDict()
